...
In the dangerous world of Corsair, a good suit of armor is often the only thing standing between a spacer and the cold
void. Armors are defined by their **Protection**, **Special Properties**, **Load**, and **Cost**.

## Armor Statistics Explained

- **Protection**: The flat amount of physical damage reduced from each incoming attack.
- **Special Properties**: Unique features or mechanics provided by the armor. See the section below for details.
...
Even the finest suit of armor can be improved with the right expertise and resources. Armor modifications allow you to
customize your gear by adding or enhancing its special properties. These modifications can be purchased from specialized
technicians and armorers across the settled worlds.

### Modification Rules

- An armor can be modified a maximum of three times. Each modification must be purchased separately.
- Modifications cannot be used to increase an armor's **Protection** or decrease its **Load**.
- When adding a special property that has a level (e.g., Tactical Webbing X), it is always added at level 1.
- When increasing an existing special property with a level, its level increases by 1.

### Modification Costs

The cost of each modification is determined by the armor's **Load**, reflecting the complexity of working with heavier
and more advanced systems.

| Armor Load | Cost per Modification |
|:-----------|:----------------------|
| 1-2        | 10,000 Credits        |
| 3-4        | 25,000 Credits        |
| 5-6        | 50,000 Credits        |
...
**Example:**
A character wants to add the `Sealed` property to their VWS "Wolfhide" armor (Load 4). According to the table, this will
cost 25,000 Credits and will count as the armor's first modification. Later, they could add `Tactical Webbing 1` for
another 25,000 Credits.
