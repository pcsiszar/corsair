...
- They use the same Attribute Pair during the test.
- If the action has a target, it must be the same for all participants. (Heal the same ally, shoot the same target, move
