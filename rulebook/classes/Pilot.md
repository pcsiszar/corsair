...
of the drone. These skills are unlocked via installable Modules, and you start out with three.

#### Batteries

The Exodrone's power source is it's batteries carried on the back. They come with a specified amount of Battery Charges.
Certain skills require you to spend these Charges to power your abilities, but some also help you to better manage your
battery power.

You gain 2 Battery Charges at the beginning of the Round if the Exodrone is attached to you.

When your Exodrone would take damage, it instead loses a Battery Charge for every 5 points of damage.
...
| Name           | Battery Cost | Description                                                                                                     |
|:---------------|:-------------|:----------------------------------------------------------------------------------------------------------------|
| Armor Up       | 3            | Gain +1 Protection until the end of the Round while in Attached mode.                                           |
| Guard Up       | X            | When taking damage, you can have the Exodrone take that damage instead while in Attached Mode.                  |
...
| Name             | Battery Cost | Description                                                                                                                                                                                                                                                                                                   |
|:-----------------|:-------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Shadow Strike    | 2            | When making a melee attack while the Exodrone is attached, it can draw a weapon of Load 2 or less from your inventory and attack with it, dealing it's damage bonus (calculated with the Exodrone Attributes) regardless if the Attack hits or misses.                                                        |
| Riposte          | 2            | When contesting a melee attack while the Exodrone is attached, it can deliver a simoltanious blow, dealing damage to the attacker equal to it's Power                                                                                                                                                         |
